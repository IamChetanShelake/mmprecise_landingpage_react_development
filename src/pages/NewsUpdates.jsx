...
//                             <h1 className="text-3xl font-bold uppercase leading-tight relative">
//                                 Latest News & Updates
...
//                                Stay updated with our latest achievements, project milestones, and industry insights shaping the future of construction.
//                             </p>
//                         </div>
//                     </div>
//                 </div>

//                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-6xl mx-auto py-10">
//                     {/* Left Large Card */}
//                     <div className="relative group rounded-xl overflow-hidden shadow-md">
//                         <img
//                             src="./images/img (3).png"
//                             alt="Project Milestone"
//                             className="w-full h-[560px] object-cover group-hover:scale-105 transition-transform duration-500"
//                         />
...
//                                 We successfully completed structural work for the Riverfront Residency Project Phase II.
//                                 The team delivered exceptional quality and safety standards—right on schedule.
//                             </p>
//                             <button className="mt-4 w-8 h-8 flex items-center justify-center rounded-full border border-gray-300 hover:bg-black hover:text-white transition">
//                                 <FiArrowRight />
//                             </button>
//                         </div>
//                     </div>
...
//                             <div className="p-6 bg-white">
//                                 <h3 className="text-lg font-semibold text-gray-900">
//                                     On-Site Safety Drive
//                                 </h3>
//                                 <p className="text-sm text-gray-600 mt-2">
//                                     Safety first! Our safety team conducted a week-long awareness and training program
//                                     across all sites, reinforcing strong safety culture.
//                                 </p>
//                                 <button className="mt-4 w-8 h-8 flex items-center justify-center rounded-full border border-gray-300 hover:bg-black hover:text-white transition">
//                                     <FiArrowRight />
//                                 </button>
...
//                                 </h3>
//                                 <p className="text-sm text-gray-600 mt-2">
//                                     We launched our Green Site Mission—implementing eco-friendly waste handling and
//                                     optimized water usage systems across all construction zones.
//                                 </p>
//                                 <button className="mt-4 w-8 h-8 flex items-center justify-center rounded-full border border-gray-300 hover:bg-black hover:text-white transition">
//                                     <FiArrowRight />
//                                 </button>
...
//             {/* ACHIEVEMENTS & AWARDS */}
//             <section className="text-center max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
//                 <div className="mb-8 flex flex-col items-center justify-center">
//                     <h2 className="text-2xl font-bold  text-gray-800">ACHIEVEMENTS </h2>
//                     <div className="bg-orange-500 rounded-full h-1 w-20 mt-2"></div>
//                 </div>
